...
const FormularioPGVEmpaque = () => {
  ...
  const guardarRegistro = async () => {
    ...
    setGuardando(true)
    try {
      // Reemplaza esto por tu función real de guardado de PGV:
      // await guardarRegistroPGVEmpaque(formulario)
      setShowModal(true)
    } catch {
  ...
  const handleModalClose = () => {
    setShowModal(false)
    navigate('/registros/PGV-EMP-001') // Cambia el ID según corresponda
  }
    ...
    <div className="container-fluid py-4 bg-light">
      <div className="card shadow-lg border-0">
        <div className="card-header bg-primary text-white d-flex align-items-center gap-3">
          <h3 className="mb-0">Control de Producción PGV Empaque</h3>
        </div>
        <div className="card-body">
          ...
          <div className="d-flex gap-2 mt-4">
            ...
            <button
              ...
              onClick={() => navigate('/registros/PGV-EMP-001')}
              disabled={guardando}
            >
              Ver Registros
            </button>
...
export default FormularioPGVEmpaque
