...
const FormularioPGVPVC = () => {
  ...
  const guardarRegistro = async () => {
    ...
    setGuardando(true)
    try {
      // await guardarRegistroPGVPVC(formulario)
      setShowModal(true)
    } catch {
  ...
  const handleModalClose = () => {
    setShowModal(false)
    navigate('/registros/PGV-PVC-001') // Cambia al path de registros real
  }
    ...
    <div className="container-fluid py-4 bg-light">
      <div className="card shadow-lg border-0">
        <div className="card-header bg-primary text-white d-flex align-items-center gap-3">
          <h3 className="mb-0">Control de Producción PGV PVC</h3>
        </div>
        <div className="card-body">
          ...
          <div className="d-flex gap-2 mt-4">
            ...
            <button
              ...
              onClick={() => navigate('/registros/PGV-PVC-001')}
              disabled={guardando}
            >
              Ver Registros
            </button>
...
export default FormularioPGVPVC
