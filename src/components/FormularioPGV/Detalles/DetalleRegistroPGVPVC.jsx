...
const DetalleRegistroPGVPVC = ({ registro: r }) => {
  // Compatibilidad para campos snake_case o camelCase
  ...
  // Helper de visualización para los grupos de retrasos
            ...
            <div className="col-md-6">
              <div className="card border-primary h-100">
                ...
                <div className="card-body">
                  ...
                  {/* Si PVC tiene algún campo específico, agrégalo aquí */}
                </div>
              </div>
            </div>
            <div className="col-md-6">
              ...
              <div className="table-responsive">
                <table className="table table-sm table-bordered mb-0">
                  ...
                  <tbody>
                    ...
                    {/* Puedes agregar aquí más campos de PVC si tu modelo lo requiere */}
                  </tbody>
                </table>
              </div>
            </div>
...
export default DetalleRegistroPGVPVC
