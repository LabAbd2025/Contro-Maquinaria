...
const DetalleRegistroPGVHemodialisis = ({ registro: r }) => {
  // Compatibilidad: nombres de campos posibles
  ...
  // Helper para detalles de retrasos
            ...
            <div className="col-md-6">
              <div className="card border-primary h-100">
                ...
                <div className="card-body">
                  ...
                  {/* Campos específicos Hemodiálisis aquí si necesitas */}
                </div>
              </div>
            </div>
            <div className="col-md-6">
              ...
              <div className="table-responsive">
                <table className="table table-sm table-bordered mb-0">
                  ...
                  <tbody>
                    ...
                    {/* Campos extras para hemodiálisis (agrega si corresponde) */}
                  </tbody>
                </table>
              </div>
            </div>
...
export default DetalleRegistroPGVHemodialisis
