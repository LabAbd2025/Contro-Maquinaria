...
import DetalleRegistroPGVEmpaque from '../Detalles/DetalleRegistroPGVEmpaque'
import { obtenerRegistrosPGVEmpaque } from '../../../services/produccionService' // Ajusta el path si es necesario

const ListaRegistrosPGVEmpaque = () => {
  ...
  // Mapear campos desde el backend al frontend
  ...
  useEffect(() => {
    const cargarRegistros = async () => {
      setLoading(true)
      try {
        const respuesta = await obtenerRegistrosPGVEmpaque()
    ...
    <div className="vh-100 vw-100 p-0 m-0 bg-light">
      <div className="sticky-top shadow-sm">
        <div className="container-fluid bg-primary text-white py-3 d-flex flex-column flex-md-row align-items-md-center justify-content-between">
          <h2 className="fw-bold mb-2 mb-md-0">Registros PGV Empaque</h2>
          <button className="btn btn-light fw-bold" onClick={() => navigate('/form/PGV-EMP-001')}>
              ...
              <div key={i} className="col-12 mb-3">
                <div className="card shadow-sm">
                  <div className="card-body">
                    ...
                    {registroExpandido === i && (
                      <div className="mt-3">
                        <DetalleRegistroPGVEmpaque registro={r} />
                      </div>
                    )}
                  </div>
                </div>
...
export default ListaRegistrosPGVEmpaque
