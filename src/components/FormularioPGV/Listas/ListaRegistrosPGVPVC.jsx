...
import DetalleRegistroPGVPVC from '../Detalles/DetalleRegistroPGVPVC'
import { obtenerRegistrosPGVPVC } from '../../../services/produccionService' // Ajusta la ruta según tu estructura

const ListaRegistrosPGVPVC = () => {
  ...
  useEffect(() => {
    const cargarRegistros = async () => {
      setLoading(true)
      try {
        const respuesta = await obtenerRegistrosPGVPVC()
    ...
    <div className="vh-100 vw-100 p-0 m-0 bg-light">
      <div className="sticky-top shadow-sm">
        <div className="container-fluid bg-primary text-white py-3 d-flex flex-column flex-md-row align-items-md-center justify-content-between">
          <h2 className="fw-bold mb-2 mb-md-0">Registros PGV PVC</h2>
          <button className="btn btn-light fw-bold" onClick={() => navigate('/form/PGV-PVC-001')}>
              ...
              <div key={i} className="col-12 mb-3">
                <div className="card shadow-sm">
                  <div className="card-body">
                    ...
                    {registroExpandido === i && (
                      <div className="mt-3">
                        <DetalleRegistroPGVPVC registro={r} />
                      </div>
                    )}
                  </div>
                </div>
...
export default ListaRegistrosPGVPVC
