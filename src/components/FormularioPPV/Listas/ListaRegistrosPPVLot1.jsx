...
import DetalleRegistroPPVLot1 from '../Detalles/DetalleRegistroPPVLot1'
import { obtenerRegistrosPPV } from '../../../services/ppvService'

const ListaRegistrosPPVLot1 = () => {
  ...
  useEffect(() => {
    const cargarRegistros = async () => {
      setLoading(true)
      try {
        // Cambia 'ppv_lot1' por el identificador exacto de tu tabla o API para LOT1
        const respuesta = await obtenerRegistrosPPV('ppv_lot1')
    ...
    <div className="vh-100 vw-100 p-0 m-0 bg-light">
      <div className="sticky-top shadow-sm">
        <div className="container-fluid bg-warning text-dark py-3 d-flex flex-column flex-md-row align-items-md-center justify-content-between">
          <h2 className="fw-bold mb-2 mb-md-0">Registros PPV Lot1</h2>
          <button className="btn btn-light fw-bold" onClick={() => navigate('/form/PPV-LOT1-001')}>
              ...
              <div key={i} className="col-12 mb-3">
                <div className="card shadow-sm">
                  <div className="card-body">
                    ...
                    {registroExpandido === i && (
                      <div className="mt-3">
                        <DetalleRegistroPPVLot1 registro={r} />
                      </div>
                    )}
                  </div>
                </div>
...
export default ListaRegistrosPPVLot1
