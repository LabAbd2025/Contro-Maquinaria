...
const DetalleRegistroPPVEmpaque = ({ registro: r }) => {
  // Extrae factores con soporte para ambos nombres posibles (API/backend/frontend)
      ...
      <div className="card mb-4 shadow-sm">
        ...
        <div className="card-body">
          <div className="row g-3">
            ...
            />
            <DetallesRetrasos
              titulo="Retrasos por ASA"
              data={retrasosASA}
              color="secondary"
            />
            <DetallesRetrasos
              titulo="Retrasos por Almacén"
              data={retrasosAlmacen}
              color="dark"
            />
            <DetallesRetrasos
...
export default DetalleRegistroPPVEmpaque
