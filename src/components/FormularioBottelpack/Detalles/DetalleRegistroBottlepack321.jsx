...
const DetalleRegistroBottlepack321 = ({ registro: r }) => {
    ...
    return (
        <div className="card-body p-4">
            {/* Tarjeta de Información General y Tiempos */}
                        ...
                        <div className="col-md-6">
                            <div className="card border-primary h-100">
                                ...
                                <div className="card-body">
                                    ...
                                    <p><strong className="text-danger">Día:</strong> {r.dia} ({r.duracionDias})</p>
            ...
            {/* Tarjeta de Métricas de Producción */}
            <div className="card mb-4 shadow-sm">
                    ...
                    <table className="table table-sm table-bordered mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className="small">∑ tiempos de factoresNoEficiencia</td>
                                <td>{formatearTiempo(sumaHorasRetrasadasNoEficiencia)}</td>
                            </tr>
                            <tr>
                                <td>Envasado Ideal</td>
                                <td className="small">
                                    Horas Trabajadas × Cantidad Ideal por Hora<br />
                                    <span className="text-muted">
                                        {formatearTiempo(r.horasTrabajadas)} × {formatearCantidad(r.cantidadIdealPorHora)}
                            ...
                            <tr>
                                ...
                                <td className="small">
                                    ...
                                    <span className="text-muted">
                                        {formatearCantidad(r.cantidadEnvasada)} ÷ {formatearCantidad(r.cantidadIdealPorHora)}
                                    </span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td className="small">∑ tiempos de todos los retrasos</td>
