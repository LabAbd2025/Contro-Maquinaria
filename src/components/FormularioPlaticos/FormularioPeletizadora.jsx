...
const FormularioPeletizadora = () => {
  ...
  const guardarRegistro = async () => {
    ...
    try {
      ...
      await guardarRegistroDivision('peletizadora', nuevoRegistro)
      setShowModal(true)
    } catch {
  ...
  const handleModalClose = () => {
    setShowModal(false)
    navigate('/registros/division_peletizadora')
  }
    ...
    <div className="container-fluid py-4 bg-light">
      <div className="card shadow-lg border-0">
        <div className="card-header bg-success text-white d-flex align-items-center gap-3">
          ...
          <h3 className="mb-0">Control Peletizadora</h3>
        </div>
        <div className="card-body">
          ...
          <div className="d-flex gap-2 mt-4">
            ...
            <button
              ...
              onClick={() => navigate('/registros/division_peletizadora')}
              disabled={guardando}
            >
              Ver Registros
            </button>
...
export default FormularioPeletizadora
