...
import DetalleRegistroFoilCap2 from '../Detalles/DetalleRegistroFoilCap2'
import { obtenerRegistrosDivision } from '../../../services/divisionService'

const ListaRegistrosFoilCap2 = () => {
  ...
  useEffect(() => {
    const cargarRegistros = async () => {
      setLoading(true)
      try {
        const respuesta = await obtenerRegistrosDivision('foil_cap_2')
  ...
  return (
    <div className="vh-100 vw-100 p-0 m-0 bg-light">
      <div className="sticky-top shadow-sm">
        <div className="container-fluid bg-info text-white py-3 d-flex flex-column flex-md-row align-items-md-center justify-content-between">
          <h2 className="fw-bold mb-2 mb-md-0">Registros Foil Cap 2</h2>
              ...
              <div key={i} className="col-12 mb-3">
                <div className="card shadow-sm">
                  <div className="card-body">
                    ...
                    {registroExpandido === i && (
                      <div className="mt-3">
                        <DetalleRegistroFoilCap2 registro={r} />
                      </div>
                    )}
                  </div>
                </div>
...
export default ListaRegistrosFoilCap2
