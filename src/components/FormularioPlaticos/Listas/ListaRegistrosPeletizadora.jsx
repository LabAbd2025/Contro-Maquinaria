...
import DetalleRegistroPeletizadora from '../Detalles/DetalleRegistroPeletizadora'
import { obtenerRegistrosDivision } from '../../../services/divisionService'

const ListaRegistrosPeletizadora = () => {
  ...
  useEffect(() => {
    const cargarRegistros = async () => {
      setLoading(true)
      try {
        const respuesta = await obtenerRegistrosDivision('peletizadora')
    ...
    <div className="vh-100 vw-100 p-0 m-0 bg-light">
      <div className="sticky-top shadow-sm">
        <div className="container-fluid bg-success text-white py-3 d-flex flex-column flex-md-row align-items-md-center justify-content-between">
          <h2 className="fw-bold mb-2 mb-md-0">Registros Peletizadora</h2>
              ...
              <div key={i} className="col-12 mb-3">
                <div className="card shadow-sm">
                  <div className="card-body">
                    ...
                    {registroExpandido === i && (
                      <div className="mt-3">
                        <DetalleRegistroPeletizadora registro={r} />
                      </div>
                    )}
                  </div>
                </div>
...
export default ListaRegistrosPeletizadora
