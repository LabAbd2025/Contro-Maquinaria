...
const FormularioSopladora = () => {
  ...
  const guardarRegistro = async () => {
    try {
      ...
      await guardarRegistroDivision('sopladora_bidones', nuevoRegistro)
      toast.success('✅ Registro guardado exitosamente.')
      navigate('/registros/sopladora_bidones')
    } catch (error) {
      console.error(error)
    ...
    <div className="container-fluid py-4 bg-light">
      <div className="card shadow-lg border-0">
        <div className="card-header bg-success text-white d-flex align-items-center gap-3">
          <h3 className="mb-0">Formulario – Sopladora de Bidones</h3>
        </div>
        <div className="card-body">
          ...
          <div className="d-flex gap-2 mt-4">
            <button className="btn btn-success btn-lg" onClick={guardarRegistro}>Guardar Registro</button>
            <button className="btn btn-outline-secondary btn-lg" onClick={() => setFormulario({ ...formulario, observaciones: '' })}>Limpiar</button>
            <button className="btn btn-info btn-lg" onClick={() => navigate('/registros/sopladora_bidones')}>Ver Registros</button>
          </div>
        </div>
      </div>
...
export default FormularioSopladora
