...
const FormularioFCS = () => {
  ...
  const guardarRegistro = async () => {
    ...
    try {
      ...
      await guardarRegistroDivision('inyectora_fcs', nuevoRegistro)
      setShowModal(true)
    } catch {
  ...
  const handleModalClose = () => {
    setShowModal(false)
    navigate('/registros/division_inyectora_fcs')
  }
    ...
    <div className="container-fluid py-4 bg-light">
      <div className="card shadow-lg border-0">
        <div className="card-header bg-success text-white d-flex align-items-center gap-3">
          ...
          <h3 className="mb-0">Control División Inyectora FCS</h3>
        </div>
        <div className="card-body">
          ...
          <div className="d-flex gap-2 mt-4">
            ...
            <button
              ...
              onClick={() => navigate('/registros/division_inyectora_fcs')}
              disabled={guardando}
            >
              Ver Registros
            </button>
