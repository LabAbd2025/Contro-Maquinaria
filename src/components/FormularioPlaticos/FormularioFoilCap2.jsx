...
const FormularioFoilCap2 = () => {
  ...
  // Autocalcula día, horas trabajadas, duración
  useEffect(() => {
  ...
  const guardarRegistro = async () => {
    ...
    try {
      ...
      await guardarRegistroDivision('foil_cap_2', nuevoRegistro)
      setShowModal(true)
    } catch {
  ...
  const handleModalClose = () => {
    setShowModal(false)
    navigate('/registros/division_foil_cap_2')
  }
    ...
    <div className="container-fluid py-4 bg-light">
      <div className="card shadow-lg border-0">
        <div className="card-header bg-warning text-dark d-flex align-items-center gap-3">
          ...
          <h3 className="mb-0">Control División Foil Cap 2</h3>
        </div>
        <div className="card-body">
          ...
          <div className="d-flex gap-2 mt-4">
            ...
            <button
              ...
              onClick={() => navigate('/registros/division_foil_cap_2')}
              disabled={guardando}
            >
              Ver Registros
            </button>
          ...
          <div className="modal-dialog modal-dialog-centered" role="document">
            <div className="modal-content shadow-lg">
              ...
              <div className="modal-footer">
                <button className="btn btn-warning" onClick={handleModalClose}>Aceptar</button>
              </div>
            </div>
          </div>
        </div>
...
export default FormularioFoilCap2
