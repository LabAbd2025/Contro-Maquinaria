...
const FormularioFoilCap = () => {
  ...
  const guardarRegistro = async () => {
    ...
    try {
      ...
      await guardarRegistroDivision('foil_cap', nuevoRegistro)
      setShowModal(true)
    } catch {
  ...
  const handleModalClose = () => {
    setShowModal(false)
    navigate('/registros/division_foil_cap')
  }
    ...
    <div className="container-fluid py-4 bg-light">
      <div className="card shadow-lg border-0">
        <div className="card-header bg-warning text-dark d-flex align-items-center gap-3">
          ...
          <h3 className="mb-0">Control División Foil Cap</h3>
        </div>
        <div className="card-body">
          ...
          <div className="d-flex gap-2 mt-4">
            ...
            <button
              ...
              onClick={() => navigate('/registros/division_foil_cap')}
              disabled={guardando}
            >
              Ver Registros
            </button>
...
export default FormularioFoilCap
